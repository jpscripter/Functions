...
# describes the function Test-CSCSync
Describe 'Test-CSCSync' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { Test-CSCSync } | Should Not Throw
    }
    It 'does something' {
      # call function Test-CSCSync and pipe the result to an assertion
      # Example:
      # Test-CSCSync | Should Be 'Expected Output'
      # Hint: 
    ...
    It 'does not return anything'     {
      Test-CSCSync | Should BeNullOrEmpty 
    }
  }
}
